...
func generateToken(user models.SystemData, c *gin.Context) {
	...
	switch user.Role {
	case models.RoleMentor, models.RoleParticipant:
		claims["sub"] = user.ID
...
func Logout(c *gin.Context) {
	...
	switch user.(type) {
	case *models.ParticipantData:
		participant := user.(*models.ParticipantData)
	...
	case *models.MentorData:
		mentor := user.(*models.MentorData)
