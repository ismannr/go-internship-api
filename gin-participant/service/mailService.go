...
func RegistrationMail(emailAddress string, name string, token string) (string, error) {
	...
	htmlBody := fmt.Sprintf(string(htmlContent), filepath.Base(filePath), name, token)
...
func ForgotPasswordMail(emailAddress string, name string, token string) (string, error) {
